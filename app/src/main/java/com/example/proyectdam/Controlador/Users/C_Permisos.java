...
public class C_Permisos {
    ...
    public int[] controlPermisos_menu() {
        switch (Activity_Menu.getInstance().c_activity_menu.userActual.getPermisos()) {
            case "Super":
            ...
            case "Encargado":
                C_PermisoEncargado C_permisoEncargado= new C_PermisoEncargado(Activity_Menu.getInstance().c_activity_menu.userActual.getTipo_permisos());
                return C_permisoEncargado.permisosMenu();
            case "Trabajador":
                C_PermisoTrabajador m_permisosTrabajador= new C_PermisoTrabajador(Activity_Menu.getInstance().c_activity_menu.userActual.getTipo_permisos());
